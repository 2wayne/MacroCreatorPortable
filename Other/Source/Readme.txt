...
user in an INI file next to MacroCreatorPortable.exe called MacroCreatorPortable.ini.
...
copy AppNamePortable.ini from this directory to MacroCreatorPortable.ini next to
MacroCreatorPortable.exe. The options in the INI file are as follows:
